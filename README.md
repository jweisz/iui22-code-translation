...
| Documentation Omission Error (DOE) | Participant omitted translation of a function’s documentation (e.g. Javadoc comment) | Count the number of Python classes and methods that were missing documentation present in Java | Missing ([Johnson et al. 1983]()); Omission error ([Panko 1998]()) |
